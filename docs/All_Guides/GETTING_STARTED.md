# Getting Started with RubyCopier

Welcome to **RubyCopier**, the official Ruby client library for MetaRPC's ultra-low latency Trade Copier engine.

## Installation

Install RubyCopier using your language's package manager:
